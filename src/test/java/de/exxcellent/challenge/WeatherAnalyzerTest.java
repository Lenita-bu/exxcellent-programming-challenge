...
public class WeatherAnalyzerTest {
    ...
    void testAnalyzeSmallestTempSpread() {
        ...
        String result1 = analyzer.analyzeSmallestTempSpread();
        ...
        String result2 = analyzer.analyzeSmallestTempSpread();
        assertEquals(result1, String.valueOf(17));
        assertEquals(result2, String.valueOf(4));
    }
}
